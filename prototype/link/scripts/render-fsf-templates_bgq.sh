...
####### Single 1
render_firstlevel $FSF_DIR/bgq.fsf.template \
                  $FIRSTLEVEL_DIR/bgq_01.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgq01 \
...
render_firstlevel $FSF_DIR/bgq.fsf.template \
                  $FIRSTLEVEL_DIR/bgq_02.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgq02 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
...
render_firstlevel $FSF_DIR/bgq.fsf.template \
                  $FIRSTLEVEL_DIR/bgq_03.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgq03 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
...
render_firstlevel $FSF_DIR/bgq.fsf.template \
                  $FIRSTLEVEL_DIR/bgq_04.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgq04 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
