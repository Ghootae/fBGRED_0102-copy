...
render_firstlevel $FSF_DIR/mr.fsf.template \
                  $FIRSTLEVEL_DIR/mr_01.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_mr01 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/freesurfer_t1_brain_mprage.nii.gz \
                  . \
                  . \
                  $EV_DIR/MR_run1 \
                  > $FSF_DIR/mr_01.fsf
...
render_firstlevel $FSF_DIR/mr.fsf.template \
                  $FIRSTLEVEL_DIR/mr_02.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_mr02 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/freesurfer_t1_brain_mprage.nii.gz \
                  . \
                  . \
