...
####### Single 1
render_firstlevel $FSF_DIR/bgc.fsf.template \
                  $FIRSTLEVEL_DIR/bgc_01.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgc01 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/BG_center_run1 \
                  > $FSF_DIR/bgc_01.fsf

render_firstlevel $FSF_DIR/bgc.fsf.template \
                  $FIRSTLEVEL_DIR/bgc_02.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgc02 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/BG_center_run2 \
                  > $FSF_DIR/bgc_02.fsf

render_firstlevel $FSF_DIR/bgc.fsf.template \
                  $FIRSTLEVEL_DIR/bgc_03.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgc03 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/BG_center_run3 \
                  > $FSF_DIR/bgc_03.fsf

render_firstlevel $FSF_DIR/bgc.fsf.template \
                  $FIRSTLEVEL_DIR/bgc_04.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_bgc04 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/BG_center_run4 \
                  > $FSF_DIR/bgc_04.fsf