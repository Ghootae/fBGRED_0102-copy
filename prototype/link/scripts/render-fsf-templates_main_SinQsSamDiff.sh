...
####### Single 1
render_firstlevel $FSF_DIR/main_SinQsSamDiff.fsf.template \
                  $FIRSTLEVEL_DIR/main_SinQsSamDiff_01.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_main01 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/main_run1 \
                  > $FSF_DIR/main_SinQsSamDiff_01.fsf

render_firstlevel $FSF_DIR/main_SinQsSamDiff.fsf.template \
                  $FIRSTLEVEL_DIR/main_SinQsSamDiff_02.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_main02 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/main_run2 \
                  > $FSF_DIR/main_SinQsSamDiff_02.fsf

render_firstlevel $FSF_DIR/main_SinQsSamDiff.fsf.template \
                  $FIRSTLEVEL_DIR/main_SinQsSamDiff_03.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_main03 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/main_run3 \
                  > $FSF_DIR/main_SinQsSamDiff_03.fsf

render_firstlevel $FSF_DIR/main_SinQsSamDiff.fsf.template \
                  $FIRSTLEVEL_DIR/main_SinQsSamDiff_04.feat \
                  $FSLDIR/data/standard/MNI152_T1_2mm_brain \
                  $NIFTI_DIR/${SUBJ}_main04 \
                  $NIFTI_DIR/${SUBJ}_t1_flash01_brain.nii.gz \
                  $NIFTI_DIR/${SUBJ}_t1_mprage_brain.nii.gz \
                  . \
                  . \
                  $EV_DIR/main_run4 \
                  > $FSF_DIR/main_SinQsSamDiff_04.fsf