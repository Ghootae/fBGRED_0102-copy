...
set feat_files(1) "<?= $DATA_FILE_PREFIX ?>"

# Add confound EVs text file
set fmri(confoundevs) 0

# Subject's structural image for analysis 1
set highres_files(1) "<?= $HIGHRES_FILE ?>"
...
# Custom EV file (EV 1)
set fmri(custom1) "<?= $EV_DIR ?>/face.txt"
...
# Custom EV file (EV 2)
set fmri(custom2) "<?= $EV_DIR ?>/scene.txt"
